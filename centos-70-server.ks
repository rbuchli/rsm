...
network --onboot=yes --device=eth0 --bootproto=static --ip=172.20.73.77 --netmask=255.255.255.0 --gateway=172.20.73.254 --nameserver=172.20.70.33 --noipv6 --hostname=srzhotrs02
